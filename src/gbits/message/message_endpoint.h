#ifndef GBITS_MESSAGE_MESSAGE_ENDPOINT_H_
#define GBITS_MESSAGE_MESSAGE_ENDPOINT_H_
...
#include "gbits/message/message_types.h"
...
#endif  // GBITS_MESSAGE_MESSAGE_ENDPOINT_H_
