#ifndef GBITS_FILE_MEMORY_FILE_PROTOCOL_H_
#define GBITS_FILE_MEMORY_FILE_PROTOCOL_H_

#include <map>
#include <memory>

#include "absl/synchronization/mutex.h"
#include "gbits/base/string_util.h"
...
#endif  // GBITS_FILE_MEMORY_FILE_PROTOCOL_H_
