...
// character encodings, integer sizes, and such. The gbits libraries do not
...
#include "gbits/base/platform_requirements.h"
...
// C++ only guarantees that the "int" type is in the range -32,768...32,767. "int"
// is used extensively in gbits for general indexing, which can easily range
// into 32-bit territory.
static_assert(
